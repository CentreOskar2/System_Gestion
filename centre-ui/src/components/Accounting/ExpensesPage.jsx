...
export default function ExpensesPage() {
  ...
  return <div className="expenses-page"><Header /><main className="expenses-content">
    ...
    <section className="expense-stats"><article><span>Total des charges</span><strong>{formatAmount(totals.auto + totals.manual)}</strong><i className="red">⊘</i></article><article><span>Charges automatiques</span><strong>{formatAmount(totals.auto)}</strong><i>▣</i></article><article><span>Charges manuelles</span><strong>{formatAmount(totals.manual)}</strong><i>☝</i></article></section>

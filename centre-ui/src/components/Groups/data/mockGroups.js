...
export const initialGroups = [
  { id: 1, name: 'Maths — 2Bac SM · G1', subject: 'Mathématiques', level: '2ème Bac', teacher: 'Karim El Amrani', branch: 'Succursale Nord', studentIds: [1, 2, 3, 4, 5, 6, 1, 2], active: true },
  { id: 2, name: 'Physique — 1Bac PC · G2', subject: 'Physique-Chimie', level: '1ère Bac', teacher: 'Salma Bennani', branch: 'Succursale Nord', studentIds: [1, 2, 3, 4, 5, 6, 1], active: true },
  { id: 3, name: 'Français — 3AC · G1', subject: 'Français', level: '9ème (3AC)', teacher: 'Youssef Tazi', branch: 'Succursale Sud', studentIds: [1, 2, 3, 4, 5, 6], active: true },
  { id: 4, name: 'Anglais — Tronc Commun · G1', subject: 'Anglais', level: 'Tronc commun', teacher: 'Nadia Idrissi', branch: 'Succursale Centre', studentIds: [1, 2, 3, 4, 5, 6, 1, 2], active: true },
  { id: 5, name: 'Arabe — 6ème · G1', subject: 'Arabe', level: '6ème année', teacher: 'Omar Fassi', branch: 'Succursale Nord', studentIds: [1, 2, 3, 4, 5, 6, 1], active: false },
]
